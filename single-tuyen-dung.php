...
<div class="test pt-[var(--header-height)]"></div>
        ...
        <div class="recruitment-detail grid grid-cols-12 gap-base">
            <div class="block-main-content relative col-span-full lg:col-span-8">
                ...
                <div class="main-detail-content mt-6 flex flex-col gap-base">
                    <div class="block-content-1 flex flex-col gap-y-5">
                ...
                <div class="social xl:absolute xl:right-full xl:top-0 -xl:mt-4 xl:mr-4.5 xl:h-full">
                    <ul class="social-list sticky rem:top-[calc(var(--header-height)+12px)]">
                        <li class="social-item"> 
                            <a class="flex-center w-10 h-10 bg-primary-2 text-base text-white rounded-full" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode(get_permalink()); ?>" target="_blank" rel="noopener noreferrer">
                                ...
                                <?php if($information['application_deadline']) : ?>
                                    <li class="apply-item flex items-center gap-x-6 py-3 border-b border-white border-opacity-30"> 
                                        <span class="icon w-10 h-auto">
                                            ...
                                            <path opacity="0.4" d="M7 0C7.5 0 8 0.5 8 1V4H20V1C20 0.5 20.4375 0 21 0C21.5 0 22 0.5 22 1V4H24C26.1875 4 28 5.8125 28 8V28C28 30.25 26.1875 32 24 32H4C1.75 32 0 30.25 0 28V8C0 5.8125 1.75 4 4 4H6V1C6 0.5 6.4375 0 7 0ZM26 12H2V28C2 29.125 2.875 30 4 30H24C25.0625 30 26 29.125 26 28V12ZM24 6H4C2.875 6 2 6.9375 2 8V10H26V8C26 6.9375 25.0625 6 24 6Z" fill="white"/>
                                            </svg>
                                        </span>
                                        <div class="block-content flex flex-col gap-y-1"><span class="top-content text-body-3"><?php _e('Expiration date', 'canhcamtheme'); ?></span><span class="bottom-content text-body-1"><?php echo $information['application_deadline']; ?></span></div>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php if($information['other']) : ?>
                                    <?php foreach($information['other'] as $item) : ?>
                                        <li class="apply-item flex items-center gap-x-6 py-3 border-b border-white border-opacity-30"> 
                                            ...
                                            <div class="block-content flex flex-col gap-y-1"><span class="top-content text-body-3"><?php echo $item['title']; ?></span><span class="bottom-content text-body-1"><?php echo $item['description']; ?></span></div>
                                        </li>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            <?php endif; ?>
                        </ul>
                        <button class="btn w-full px-6 py-3.5 mt-3 text-body-1 text-primary-2 bg-white " id="apply-now-btn"><?php _e('Ứng tuyển ngay', 'canhcamtheme'); ?></button>
                    </div>
                            ...
                            if ($similar_jobs->have_posts()) :
                                while ($similar_jobs->have_posts()) : $similar_jobs->the_post();
                                    ...
                                    <li class="similar-jobs-item group py-5 border-b border-utility-gray-100">
                                        ...
                                        <h3 class="title heading-4 mt-2.5 line-clamp-2 transition-300 group-hover:text-primary-2">
...
<div class="fixed z-[1001] w-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" id="popup-applyNow">
    <div class="container-1600 relative"> 
        <div class="wrap-popup-applyNow absolute-center w-[calc(100%-30px)] md:w-[calc(1026/1600*100%)] flex flex-col gap-y-4 p-5 -md:pt-7 md:p-10 bg-white mx-auto">
            <div class="btn-close absolute right-0 top-0 flex-center w-7 h-7 md:w-10 md:h-10 bg-primary-2 text-base md:text-xl text-white cursor-pointer"><i class="fa-light fa-xmark"></i></div><span class="popup-applyNow-title heading-3 -md:heading-4"><?php the_title(); ?></span>
            <p class="subtitle text-body-1"><?php _e('Contact us for more information and be a part of the wonderful journey', 'canhcamtheme'); ?></p>

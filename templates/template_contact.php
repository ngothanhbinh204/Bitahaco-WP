...
<section class="section-banner-secondary pt-[var(--header-height)]"> 
    <div class="block-banner img-ratio ratio:pt-[1_2] md:ratio:pt-[600_1920]"> 
        <img class="lozad undefined" data-src="<?php echo $banner['url']; ?>" alt="<?php echo $banner['alt']; ?>"/>
    </div>
</section>
        ...
        <div class="contact flex -lg:flex-col-reverse -lg:gap-base">
            ...
            <?php if(get_field('form')) : ?>
                ...
                <div class="block-contact-form w-full lg:w-7/12 xl:w-[calc(1121/1600*100%)] lg:pr-8">
                    <h1 class="contact-title heading-1"><?php echo $title ? $title : __('Liên hệ', 'canhcamtheme'); ?></h1>
                    <?php if($description) : ?>
                        <div class="subtitle text-body-1 mt-6"><?php echo $description; ?></div>
                    <?php endif; ?>
            ...
            <?php if(get_field('information')) : ?>
                ...
                <div class="block-contact-info w-full lg:w-5/12 xl:w-[calc(480/1600*100%)]">
                    <div class="contact-info p-10 rounded-lg bg-primary-2">
                        <?php if($title) : ?>
                            ...
                            <ul class="contact-info-list mt-6 flex flex-col gap-y-5">
                                <?php foreach($info as $item) : ?>
                                    <li class="contact-info-item flex gap-x-2">
                                        <div class="icon text-lg text-primary-1">
                                            <?php if(strpos($item['icon'], 'facebook') !== false) : ?>
                                                <i class="fa-brands fa-<?php echo $item['icon']; ?>"></i>
                                            <?php else : ?>
                                                <i class="fa-regular fa-<?php echo $item['icon']; ?>"></i>
                                            <?php endif; ?>
                                        </div>
                                        <span class="text-base text-primary-1">|</span>
                                        <div class="block-content text-white">
                                            <span class="title text-body-1 font-bold"><?php echo $item['label']; ?></span>
                                            <div class="content text-body-1 mt-3 break-all"><?php echo $item['value']; ?><div>
                                        </div>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
